...
function click_hand()
	nLog("find hand")
	x,y = findMultiColorInRegionFuzzy( 0x30bf6c, "11|6|0xffffff,27|13|0xffffff,44|13|0x30bf6c,44|19|0x30bf6c,29|34|0xffffff,26|40|0x30bf6c", 90, 1000, 10, 1080, 2080)
	if x~=-1 then
		click(x,y+80)
		return true
	end
